...
public class FunsDBScheme {
    ...
    public static final String SCHEDULES_SUBJECTS = "subjects";
    public static final String SCHEDULES_ODD = "odd";
    public static final String SCHEDULES_EVEN = "even";
    public static final String SCHEDULES_UNUSUAL = "unusual";
}
